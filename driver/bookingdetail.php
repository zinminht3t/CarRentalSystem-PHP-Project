			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title">
						...
						<a href="ddashboard.php" class="pull-right"><i class="fa fa-close"></i></a>
						<ul class="nav navbar-right panel_toolbox">
							<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
							</li>
							<?php if($rowgetbooking['confirmstatus'] == 'confirmed'){ ?>
							<a href="bookingcomplete.php?bookingid=<?php echo $bookingid;?>" class="btn btn-success"><i class="fa fa-right"> Mark as Completed</i></a>
							<?php } ?>
						</ul>
						<div class="clearfix"></div>
					</div>
					...
					<div class="x_content">
						<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
							...
							<h4><i class="fa fa-user user-profile-icon"></i> <?php echo $rowgetcustomer['customername']; ?></h4>
